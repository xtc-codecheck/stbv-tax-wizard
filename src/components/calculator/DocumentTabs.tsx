...
import { X, Plus, FileText, Copy, Pencil, Check, MoreVertical } from 'lucide-react';
          ...
          >
            ...
            {editingTabId === tab.id ? (
              ...
              <>
                ...
                {/* Context menu trigger (does NOT switch tabs) */}
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      className="p-0.5 rounded opacity-60 hover:opacity-100 hover:bg-muted transition-opacity"
                      onClick={(e) => e.stopPropagation()}
                      aria-label="Tab-Optionen"
                    >
